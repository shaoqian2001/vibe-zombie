...
func _ready() -> void:
	...
	# The 1v1 Duel has no zombies, missions or loot — the only pickups are the
	# weapons the host drops from the debug panel, which replicate via
	# pickup_state like any other pickup.
